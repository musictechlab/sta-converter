...
1. Check existing [issues](https://github.com/musictechlab/sta-converter/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/sta-converter/discussions)
